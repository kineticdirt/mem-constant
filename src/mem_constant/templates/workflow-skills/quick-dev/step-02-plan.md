...
Before approving, you can open the spec file in an editor or ask me questions and tell me what to change. You can also use `advanced-elicitation`, `party-mode`, or `code-review` skills, ideally in another session to avoid context bloat.
