...
|------|-------------|-------|
| DS | Write the next or specified story's tests and code | dev-story |
| QD | Unified quick flow — clarify intent, plan, implement, review, present | quick-dev |
| QA | Generate API and E2E tests for existing features | qa-generate-e2e-tests |
| CR | Initiate a comprehensive code review across multiple quality facets | code-review |
| SP | Generate or update the sprint plan that sequences tasks for implementation | sprint-planning |
| CS | Prepare a story with all required context for implementation | create-story |
| ER | Party mode review of all work completed across an epic | retrospective |
