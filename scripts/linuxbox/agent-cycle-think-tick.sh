...
# Align with think-free-swap.json ordered[] — never re-add inclusionai/ling-3.0-flash:free (404).
fallback = "poolside/laguna-xs-2.1:free,nvidia/nemotron-3-super-120b-a12b:free,cohere/north-mini-code:free,nvidia/nemotron-3-ultra-550b-a55b:free,poolside/laguna-s-2.1:free,google/gemma-4-31b-it:free,openai/gpt-oss-20b:free,nvidia/nemotron-3-nano-30b-a3b:free,nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free,google/gemma-4-26b-a4b-it:free,nvidia/nemotron-nano-9b-v2:free"
try:
