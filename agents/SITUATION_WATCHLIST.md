# Situation watchlist (edit this)

Topics for the **daily Hermes digest** (`situation-hermes` cron on linuxbox). Inspired by [hipcityreg/situation-monitor](https://github.com/hipcityreg/situation-monitor) (dashboard/Vercel **not** used here).
...
Add/remove bullets above, then save. Next **09:00** cron run on linuxbox picks up changes.
